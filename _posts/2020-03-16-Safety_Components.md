...
| [IEC 61946-3](https://webstore.iec.ch/publication/22472) | Safety of machinery - Electro-sensitive protective equipment - Part 4-3: Particular requirements for equipment using vision based protective devices (VBPD) - Additional requirements when using stereo vision techniques (VBPDST)|  B    |
| IEC 62998-1 | Safety of machinery <br> Safety-related sensors used for the protection of persons | B |
